...
final profilePictureProvider = FutureProvider.family<String?, String>((ref, userId) async {
...
class ProfilePictureUploadNotifier extends StateNotifier<AsyncValue<String?>> {
  ...
  Future<void> uploadProfilePicture({
    ...
    try {
      ...
      final uploadTask = await userFolderRef.child(fileName).putFile(
        file,
...
final profilePictureUploadProvider = StateNotifierProvider<ProfilePictureUploadNotifier, AsyncValue<String?>>((ref) {
