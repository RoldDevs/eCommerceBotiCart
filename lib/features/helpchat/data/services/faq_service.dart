...
class FAQService {
  static final List<FAQItem> _faqs = [
    ...
    FAQItem(
      ...
      answer:
          "BotiCart is your trusted online pharmacy platform that connects you with verified pharmacies. You can browse medicines, place orders, chat with pharmacists, and get your medications delivered to your doorstep.",
    ...
    FAQItem(
      ...
      answer:
          "Yes! You can order prescription medicines by uploading a valid prescription from your doctor. Go to your account settings to upload prescription documents. Our pharmacists will verify before processing your order.",
    ...
    FAQItem(
      ...
      answer:
          "We accept various payment methods including credit/debit cards, digital wallets, and cash on delivery (where available). Payment options will be shown during checkout.",
    ...
    FAQItem(
      ...
      answer:
          "Delivery charges vary based on distance and delivery speed. The exact fee will be calculated and shown during checkout before you confirm your order.",
    ...
    FAQItem(
      ...
      answer:
          "Yes! You can track your order in real-time. Go to 'Orders' section in the app to see your order status, estimated delivery time, and delivery person details.",
    ...
    FAQItem(
      ...
      answer:
          "Yes! All pharmacies on BotiCart are verified and licensed. We ensure they meet quality standards and have proper certifications to sell medicines safely.",
    ...
    FAQItem(
      ...
      answer:
          "Yes! You can save medicines to your favorites by tapping the heart icon on any medicine. Access your saved items from your account section.",
    ...
    FAQItem(
      ...
      answer:
          "You can cancel your order if it hasn't been prepared yet. Go to 'Orders' section, find your order, and tap 'Cancel Order'. If already prepared, contact the pharmacy directly.",
    ...
    FAQItem(
      ...
      answer:
          "Generic medicines contain the same active ingredients as branded ones but are usually more affordable. Branded medicines are original formulations by pharmaceutical companies. Both are equally effective when prescribed properly.",
