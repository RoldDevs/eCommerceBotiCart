                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: isAdminReply
                          ? LinearGradient(
                              colors: [
                                const Color(0xFF8ECAE6).withOpacity(0.2), // Changed from Colors.orange.shade50
                                const Color(0xFF8ECAE6).withOpacity(0.1), // Changed from Colors.orange.shade100.withOpacity(0.7)
                              ],
                              begin: Alignment.topLeft,
                              end: Alignment.bottomRight,
                            )
                      ...
                      border: Border.all(
                        color: isAdminReply 
                            ? const Color(0xFF8ECAE6).withOpacity(0.4) // Changed from Colors.orange.shade200
                            : isUserReply
                        ...
                        children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: const Color(0xFF8ECAE6).withOpacity(0.3), // Changed from Colors.orange.shade100
                                      borderRadius: BorderRadius.circular(4),
                                    ),
                                    child: Icon(
                                      Icons.admin_panel_settings_rounded,
                                      size: 12,
                                      color: const Color(0xFF2A4B8D), // Changed from Colors.orange.shade700
                                    ),
                                  ),
                                  ...
                                  Text(
                                    ...
                                    style: GoogleFonts.poppins(
                                      fontSize: 11,
                                      fontWeight: FontWeight.w600,
                                      color: const Color(0xFF2A4B8D), // Changed from Colors.orange.shade800
                                    ),
                                  ),
                                ],
                              ),
                          ...
                          Text(
                            ...
                            style: GoogleFonts.poppins(
                              ...
                              fontWeight: FontWeight.w400,
                              color: isAdminReply 
                                  ? const Color(0xFF2A4B8D) // Changed from Colors.orange.shade900
                                  : isUserReply
                          ...
                          Align(
                            ...
                            child: Text(
                              ...
                              style: GoogleFonts.poppins(
                                ...
                                fontWeight: FontWeight.w400,
                                color: isAdminReply 
                                    ? const Color(0xFF8ECAE6) // Changed from Colors.orange.shade600
                                    : isUserReply
